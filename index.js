...
let modal_bt = document.querySelector('.menu_bt')
...
menu_bt.onclick = () => {
    modal.classList.add('menu_show')
    body.classList.add('bidy_hidden')

}

close_modal.onclick = () => {
    body.classList.remove('bidy_hidden')
    modal.classList.remove('menu_show')
